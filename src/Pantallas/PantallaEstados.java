...
public class PantallaEstados extends JDialog {
	...
	public PantallaEstados() {
		...
		lblHasta.setBounds(392, 36, 87, 19);
		...
		lblTotalVendido.setBounds(41, 111, 208, 19);
		...
		lblGanancias.setBounds(41, 141, 168, 19);
		...
		lblPerdidas.setBounds(41, 169, 168, 19);
		contentPane.add(lblPerdidas);
		
		JLabel lblArticuloMasVendido = new JLabel("ARTICULO MAS VENDIDO:");
		lblArticuloMasVendido.setFont(new Font("Gotham-Medium", Font.BOLD, 12));
