...
public class Confirmacion extends JDialog {
	...
	public Confirmacion() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setFont(new Font("Gotham-Medium", Font.BOLD, 12));
			lblNewLabel.setBounds(66, 23, 307, 39);
			contentPanel.add(lblNewLabel);
		}
		{
			JLabel lblSiDeseaHacerlo = new JLabel("Si desea hacerlo clickee Aceptar");
			lblSiDeseaHacerlo.setFont(new Font("Gotham-Medium", Font.BOLD, 12));
		...
		}
		{
			...
			lblDeLoContrario.setFont(new Font("Gotham-Medium", Font.BOLD, 12));
