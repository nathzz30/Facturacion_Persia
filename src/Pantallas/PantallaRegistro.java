...
public class PantallaRegistro extends JDialog {
	...
	public PantallaRegistro() {
		...
		lblPrecioDeVenta.setFont(new Font("Gotham", Font.BOLD, 12));
		...
		lblPrecioDeVenta_1.setFont(new Font("Gotham", Font.BOLD, 12));
		...
		lblCantidadEnAlmacen.setFont(new Font("Gotham", Font.BOLD, 12));
